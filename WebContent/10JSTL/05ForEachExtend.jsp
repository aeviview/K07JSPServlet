...
<body>
	...
	<!-- 
		...
		set태그로 변수를 선언한다. 즉, 영역에 저장한다는 뜻이다.
	-->
	...
	lists.add(new MemberDTO("Song", "3333", "송씨", null));
	%>
	...
	<%-- 
		루프내에서 객체를 전달할 변수 map을 통해
		맵의 key값과 value값을 알아낼 수 있다.
			key => ${맵의이름.key}
			value => ${맵의이름.value}
	 --%>
	<h4>키 값을 모를 때 : 확장 for문 사용</h4>
	<ul>

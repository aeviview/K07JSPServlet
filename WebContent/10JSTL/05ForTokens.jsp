...
<body>
	<h2>forTokens 태그</h2>
	<!-- 
	 	StringTokenize클래스 : 문자열을 토큰(구분자)으로 나눠서 출력할 때 사용한다.
	 		- countTokens() : 토큰의 갯수를 반환한다.
	 		- hasmoreTokens() : 꺼내올 토큰이 있다면 true를 반환
	 		- nextToken() : 해당 토큰을
	 -->
	<%
	...
	out.println("<h3>StringTokenizer 클래스 사용</h3>");
	...
	/*
		String클래스의 split() 메소드
			...
			- JavaScript에도 동일한 함수가 존재하고,
			다른 웹프로그래밍 언어에서도 많이 사용된다.
	*/
	...
	<c:forTokens items="<%=colors %>" delims="," var="color">
		<h5 style="color:${color};">JSTL 싫어요!</h5>
	</c:forTokens>

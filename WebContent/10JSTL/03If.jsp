...
<body>
	...
	<!-- 
		if(numVar%2==0)와 동일한 조건으로,
		해당 조건문은 true를 반환하므로 태그 사이의 문장이 출력된다.
		그리고 var속성에 지정된 result에 true가 저장된다.
	 -->
	...
	<!-- 
		JSTL의 if문은 else가 없기 때문에 참 or 거짓의 형태로 구문을 만들 때는
	...
	<c:if test="${JAVA ne 'JAVA' }">
		${strVar }는 자바가 아니다 <br /> <!-- 결과가 출력된다! -->
	</c:if>
	...
	<!-- 
		아이디, 패스워드를 입력 후 submit 한 후 EL식을 통해 파라미터로 받은 후

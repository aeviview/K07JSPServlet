...
<%-- 
	<EL에서 Java클래스의 메소드 호출 절차 및 방법>
 	...
 	4. jsp파일에서 EL을 통해 메소드를 호출한다.
 		페이지상단에 taglib지시어를 선언하고 호출시에는 ${접두어:메소드명(인자)} 형태로 호출한다.
 --%>
...
<body>
	...
	<ol>
		...
		<li>
			my:isNumber("송30") => ${my:isNumber("송30") }
		</li>
	</ol>
...
<!-- -----------------여기 수정해야함 ㅠㅠ--------------------------- -->	
	<ul>
		<li>
			주민번호 123456-100000 : ${my:getGender("123456-1000000") }
		</li>
		<li>
			주민번호 123456-200000 : ${my:getGender("123456-2000000") }
		</li>
		<li>
			주민번호 123456-500000 : ${my:getGender("123456-5000000") }
		</li>
	</ul>

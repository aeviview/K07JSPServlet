...
<body>
	...
	<!-- 
		...
		영역에 저장될 때는 Object형으로 자동형변환 되므로, 
	...
	String dateString = "";
	//해당 객체가 Date형으로 사용 가능하다면
	if(obj instanceof Date)
	{
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); //형 변환 후 사용한다!
	...
	*/
	...
	<a href="pageResult.jsp">
		page영역 공유확인을 위한 링크</a>
	<br/>
	
	<!-- 
		include 지시어를 사용하는 경우
		같은 페이지로 취급되어 페이지 영역이 공유된다.
	 -->
